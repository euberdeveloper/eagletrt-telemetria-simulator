...
export class Logger {
    ...
    public info(message: string, scope = this.scope, object?: any): void {
        if (!this.silent) {
    ...
    public success(message: string, scope = this.scope, object?: any): void {
        if (!this.silent) {
    ...
    public debug(message: string, scope = this.scope, object?: any): void {
        if (!this.silent) {
    ...
    public warning(message: string, scope = this.scope, object?: any): void {
        if (!this.silent) {
    ...
    public error(message: string, scope = this.scope, error?: any): void {
        if (!this.silent) {
